...
public class AccountsService {
    ...
    public Optional<Account> getByClientIdAndAccNumber(Long clientId, String accNumber){
        return  accountsRepository.findByClientIdAndAccountNumber(clientId, accNumber);
    }
